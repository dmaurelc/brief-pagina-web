...
// Componente mejorado para tarjetas drag-and-drop
...
const AdminDashboard = () => {
  ...
  // Configuración de las columnas del dashboard en español
  const columns = [
    {
      id: "pending",
      title: "Pendientes",
  ...
  return (
    <div className="min-h-screen bg-accent-700">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Indicador de métodos disponibles */}
        <div className="mt-6 p-4 bg-card border border-border rounded-lg">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            <AlertCircle className="w-4 h-4" />
            <span>
              <strong>Métodos disponibles:</strong> Arrastra las tarjetas entre
              columnas, usa el menú de opciones (⋮) para cambiar estados, o haz clic en "Editar Presupuesto" para la gestión completa.
            </span>
          </div>
        </div>
